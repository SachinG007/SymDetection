...
for img in glob.glob("/Users/sachin007/Desktop/BTP_data/test_data/test_data_format/*.jpg"):
    n= cv.imread(img,1)
...
for i in range(data_len):
	...
	gt_img_r   = cv.resize(gt_img,None,fx = 0.703125,fy=1)
	
	aug_img = np.concatenate((orig_img_r, gt_img_r), axis=1)
	# print(np.shape(aug_img))
	filename = "/Users/sachin007/Desktop/BTP_data/test_data/test_data_radon/testImg_%i*.jpg"%i
